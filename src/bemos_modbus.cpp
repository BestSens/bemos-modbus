...
namespace {
	...
	const json default_mb_register_map = {			
		...
		{{"start address", 27}, {"type", "float"}, {"source", "ks_data_0"}, {"attribute", "effective peak velocity"}, {"ignore oldness", true}, {"coerce_zero", 0.5}},
		{{"start address", 29}, {"type", "float"}, {"source", "ks_data_1"}, {"attribute", "effective peak velocity"}, {"ignore oldness", true}, {"coerce_zero", 0.5}},
		{{"start address", 31}, {"type", "float"}, {"source", "ks_data_2"}, {"attribute", "effective peak velocity"}, {"ignore oldness", true}, {"coerce_zero", 0.5}},
		{{"start address", 33}, {"type", "float"}, {"source", "ks_data_3"}, {"attribute", "effective peak velocity"}, {"ignore oldness", true}, {"coerce_zero", 0.5}},
		{{"start address", 35}, {"type", "float"}, {"source", "ks_data_4"}, {"attribute", "effective peak velocity"}, {"ignore oldness", true}, {"coerce_zero", 0.5}},
		{{"start address", 37}, {"type", "float"}, {"source", "ks_data_5"}, {"attribute", "effective peak velocity"}, {"ignore oldness", true}, {"coerce_zero", 0.5}},
		{{"start address", 39}, {"type", "float"}, {"source", "ks_data_6"}, {"attribute", "effective peak velocity"}, {"ignore oldness", true}, {"coerce_zero", 0.5}},
		{{"start address", 41}, {"type", "float"}, {"source", "ks_data_7"}, {"attribute", "effective peak velocity"}, {"ignore oldness", true}, {"coerce_zero", 0.5}},
