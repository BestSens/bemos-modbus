...
int main(int argc, char **argv){
	...
	json mb_register_map = {
			...
			{{"start address", 27}, {"type", "float"}, {"source", "ks_data_0"}, {"attribute", "max abs val velo"}, {"ignore oldness", true}},
			{{"start address", 29}, {"type", "float"}, {"source", "ks_data_1"}, {"attribute", "max abs val velo"}, {"ignore oldness", true}},
			{{"start address", 31}, {"type", "float"}, {"source", "ks_data_2"}, {"attribute", "max abs val velo"}, {"ignore oldness", true}},
			{{"start address", 33}, {"type", "float"}, {"source", "ks_data_3"}, {"attribute", "max abs val velo"}, {"ignore oldness", true}},
			{{"start address", 35}, {"type", "float"}, {"source", "ks_data_4"}, {"attribute", "max abs val velo"}, {"ignore oldness", true}},
